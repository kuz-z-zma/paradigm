...
<h3 class="media-heading"><a href="<?php echo html_encode(getAlbumURL()); ?>" title="<?php echo gettext('View album: '); ?><?php printBareAlbumTitle(); ?>"><i class="glyphicon glyphicon-folder-close"></i><?php printAlbumTitle(); ?></a></h3>
<?php } else { ?>
<div class="media <?php if (getOption('paradigm_full-width')) {echo 'col-xl-3 '; } ?>col-lg-6 col-md-6 col-sm-6 col-xs-12">
<?php if (class_exists('favorites') && ($_zp_gallery_page == 'favorites.php')) { ?><div class="favorites fav-albums"><?php printAddToFavorites($_zp_current_album, '', gettext('Remove')); ?></div><?php } ?>
