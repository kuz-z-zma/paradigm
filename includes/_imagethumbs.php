...
<h3 class="media-heading col-xs-12"><i class="glyphicon glyphicon-picture"></i>Images:</h3>
<?php } else { ?>
<h2 class="media-heading col-xs-12"><i class="glyphicon glyphicon-picture"></i>Images:</h2>
<?php } ?>
