...
<div class="col-sm-9">
<input class="form-control" type="text" id="title" name="title" size="22" value="<?php echo html_encode($mailcontent['title']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="name" name="name" autocomplete="name" size="22" value="<?php echo html_encode($mailcontent['name']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="username" name="username" autocomplete="username" size="22" value="<?php echo html_encode($mailcontent['honeypot']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="company" name="company" autocomplete="organization" size="22" value="<?php echo html_encode($mailcontent['company']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="street" name="street" autocomplete="street-address" size="22" value="<?php echo html_encode($mailcontent['street']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="city" name="city" autocomplete="address-level2" size="22" value="<?php echo html_encode($mailcontent['city']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="state" name="state" autocomplete="address-level1" size="22" value="<?php echo html_encode($mailcontent['city']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="country" name="country" autocomplete="country" size="22" value="<?php echo html_encode($mailcontent['country']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="postal" name="postal" size="22" autocomplete="postal-code" value="<?php echo html_encode($mailcontent['postal']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="email" name="email" size="22" autocomplete="email" value="<?php echo html_encode($mailcontent['email']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="website" name="website" size="22" autocomplete="url" value="<?php echo html_encode($mailcontent['website']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="phone" name="phone" size="22" autocomplete="tel" value="<?php echo html_encode($mailcontent['phone']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
<?php } ?>
...
<div class="col-sm-9">
<input type="text" class="form-control" id="subject" name="subject" size="22" value="<?php echo html_encode($mailcontent['subject']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
</div>
</div>
...
<div class="col-sm-9">
<textarea class="form-control" id="message" rows="6" cols="42" name="message" <?php if ($_processing_post) echo ' disabled="disabled"'; ?>><?php echo $mailcontent['message']; ?></textarea>
</div>
</div>
