...
<form id="mailform" action="<?php echo html_encode(getRequestURI()); ?>" method="post" accept-charset="UTF-8" class="form-horizontal" role="form">
	...
	if (showOrNotShowField(getOption('contactform_name'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="name" name="name" size="22" value="<?php echo html_encode($mailcontent['name']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	...
	<div class="form-group" style="display:none;">
		...
		<div class="col-sm-9">	
			<input type="text" class="form-control" id="username" name="username" size="22" value="<?php echo html_encode($mailcontent['honeypot']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
		</div>
	</div>
	<?php
	if (showOrNotShowField(getOption('contactform_company'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="company" name="company" size="22" value="<?php echo html_encode($mailcontent['company']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	if (showOrNotShowField(getOption('contactform_street'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="street" name="street" size="22" value="<?php echo html_encode($mailcontent['street']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>	
		</div>
		<?php
	}
	if (showOrNotShowField(getOption('contactform_city'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="city" name="city" size="22" value="<?php echo html_encode($mailcontent['city']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	if (showOrNotShowField(getOption('contactform_state'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="state" name="state" size="22" value="<?php echo html_encode($mailcontent['city']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	if (showOrNotShowField(getOption('contactform_country'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="country" name="country" size="22" value="<?php echo html_encode($mailcontent['country']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	if (showOrNotShowField(getOption('contactform_postal'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="postal" name="postal" size="22" value="<?php echo html_encode($mailcontent['postal']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	if (showOrNotShowField(getOption('contactform_email'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="email" name="email" size="22" value="<?php echo html_encode($mailcontent['email']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	if (showOrNotShowField(getOption('contactform_website'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="website" name="website" size="22" value="<?php echo html_encode($mailcontent['website']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	if (showOrNotShowField(getOption('contactform_phone'))) {
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="phone" name="phone" size="22" value="<?php echo html_encode($mailcontent['phone']); ?>"<?php if ($_processing_post) echo ' disabled="disabled"'; ?> />
			</div>
		</div>
		<?php
	}
	...
	<div class="mailmessage form-group">
		...
		<div class="col-sm-9">
			<textarea class="form-control" id="message"  rows="6" cols="42" class="form-control" name="message" <?php if ($_processing_post) echo ' disabled="disabled"'; ?>><?php echo $mailcontent['message']; ?></textarea>
		</div>
	</div>
	<?php
	if (!$_processing_post) {
